...
var _ref4 = process.env.NODE_ENV === "production" ? {
  ...
  name: "epk2qg-renderDates",
  styles: "padding-right:6px;label:renderDates;",
  toString: _EMOTION_STRINGIFIED_CSS_ERROR__
};
...
var Calendar = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(Calendar, [{
    ...
    value: function renderDays() {
      ...
      return this.state.days.map(function (x, i) {
        return (0, _react2.jsx)("div", {
          className: "day-name",
          key: "day-of-week-" + i,
          css: ["border-color:LightGray;", (0, _get2["default"])(_this2.props.styles, 'day', {}), process.env.NODE_ENV === "production" ? "" : ";label:renderDays;"]
        }, x);
      });
      ...
      return [(0, _toConsumableArray2["default"])(Array(dayOfWeek)).map(function (x, i) {
        ...
        if (x == _this3.state.today.date() && _this3.state.current.isSame(_this3.state.today, "month")) {
          return (0, _react2.jsx)("div", {
            className: "day",
            key: "day-" + x,
            css: [(0, _get2["default"])(_this3.props.styles, 'day', {}), (0, _get2["default"])(_this3.props.styles, 'today', {}), process.env.NODE_ENV === "production" ? "" : ";label:renderDates;"]
          }, (0, _react2.jsx)("span", {
            css: _ref4
          }, x), (0, _react2.jsx)("div", {
            className: "innerDay",
    ...
    value: function render() {
      ...
      return (0, _react2.jsx)("div", {
        className: "calendar",
        css: ["font-size:18px;border:1px solid;min-width:300px;position:relative;border-color:LightGray;color:#51565d;", (0, _get2["default"])(this.props.styles, 'calendar', {}), process.env.NODE_ENV === "production" ? "" : ";label:render;"]
      }, (0, _react2.jsx)("div", {

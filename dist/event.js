...
var _ref5 = process.env.NODE_ENV === "production" ? {
  ...
  name: "w2e8bp-render",
  styles: "font-weight:500;label:render;",
  toString: _EMOTION_STRINGIFIED_CSS_ERROR__
};
    ...
    value: function render() {
      ...
      return (0, _react2.jsx)(_reactPopper.Manager, null, (0, _react2.jsx)("div", {
        ...
        return (0, _react2.jsx)("div", {
          css: [_ref2, _this2.props.eventStyles, process.env.NODE_ENV === "production" ? "" : ";label:render;"],
          onClick: _this2.toggleTooltip,
          ref: ref
        }, (0, _react2.jsx)("div", {
          className: "event-text",
          css: ["color:#51565d;padding:3px 0px 3px 20px;margin-right:5px;overflow-x:hidden;white-space:nowrap;position:relative;text-align:left;", _this2.props.eventTextStyles, process.env.NODE_ENV === "production" ? "" : ";label:render;"]
        }, (0, _react2.jsx)("span", {
          css: [{
            position: "absolute",
            top: "5px",
            ...
            height: "15px",
            width: "15px"
          }, _this2.props.eventCircleStyles, process.env.NODE_ENV === "production" ? "" : ";label:render;"]
